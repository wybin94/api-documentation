...
class MemberControllerApiSpecTest {
    ...
    void getMembers() throws Exception {
        ResultActions perform = mockMvc.perform(RestDocumentationRequestBuilders.get("/members"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id").exists())
                .andExpect(jsonPath("$[0].name").exists());

        perform.andDo(MockMvcRestDocumentationWrapper.document(
